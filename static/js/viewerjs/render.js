...
function ODFViewerPlugin() {
    function b(b) {
        ...
        a.async = !1;
        a.src = "/static/js/viewerjs/webodf.js";
...
function PDFViewerPlugin() {
    ...
    function r(d) {
        b("/static/js/viewerjs/compatibility.js", function() {
            b("/static/js/viewerjs/pdf.js");
            b("/static/js/viewerjs/ui_utils.js");
            b("/static/js/viewerjs/text_layer_builder.js");
            b("/static/js/viewerjs/pdfjsversion.js", d)
        });
    }
    ...
    this.initialize = function(a, b) {
        ...
        console.log(b)
        r(function() {
            PDFJS.workerSrc = "/static/js/viewerjs/pdf.worker.js";
